...
func TestEncryptedFileDriver(t *testing.T) {
	...
	doEncryptedFileTest(t, func() *EncryptedFile {
		return EncryptedFileDriver(WithEncryptedFilePath(context.Background(), secretDir), password)
	})
}
...
func TestSaltedFileDriver(t *testing.T) {
	...
	doEncryptedFileTest(t, func() *EncryptedFile {
		return SaltedFileDriver(WithEncryptedFilePath(context.Background(), secretDir))
	})
}
